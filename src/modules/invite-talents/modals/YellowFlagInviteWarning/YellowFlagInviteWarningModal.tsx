...
const getReasonLabel = (reason: string | null, description: string | null): string => {
    ...
    >
      <View style={styles.container}>
        <View style={styles.noticeCard}>
          ...
          <AppText typography="semibold_12" color="black_60" style={[styles.label, styles.labelFirst]}>
            Reason
          </AppText>
