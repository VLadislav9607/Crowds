...
export const FLAG_NOTES: Record<AvatarFlag, string> = {
  ...
  red:
    'You are selecting a Red Flag, which highlights major concerns with this talent. Admins will be alerted to monitor and assess the situation. If the issue worsens, this may escalate to a black flag.',
  black:
