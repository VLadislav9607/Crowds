      ...
      <TalentEventsList
        ...
        ListHeaderComponent={<>
          <View style={styles.searchContainer}>
            ...
            <TouchableOpacity onPress={()=>goToScreen(Screens.TalentSearchEvents, { showFilter: true})} activeOpacity={0.8} style={styles.filterButton}>
          ...
          <View style={styles.listTitle}>
            <AppText typography='extra_bold_18' color='black'>Dashboard</AppText>

            <TouchableOpacity hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
              <AppText typography='regular_12' color='black'>View all</AppText>
            </TouchableOpacity>
          </View>
        </>}
      />
