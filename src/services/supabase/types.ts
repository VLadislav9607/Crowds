...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      event_event_tags: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "event_event_tags_tag_id_fkey"
            columns: ["tag_id"]
            isOneToOne: false
    ...
    Functions: {
      accept_event_nda: { Args: { p_event_id: string }; Returns: undefined }
      ...
      publish_event_draft: { Args: { event_id_param: string }; Returns: string }
